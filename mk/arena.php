...
"map<?php echo ($c+1); ?>" : {
	...
	case 51:
		...
		for ($i=0;$i<36;$i++) {
			...
			switch ($arene["p$i"]) {
			case 0:
				echo "[[$x,$y,99,21],[0,7]],[[[$x,".($y+78)."],[".($x+17).",".($y+83)."],[".($x+22).",".($y+100)."],[$x,".($y+100)."]],[4.95,-4.95]],[[[".($x+78).",".($y+100)."],[".($x+83).",".($y+83)."],[".($x+100).",".($y+78)."],[".($x+100).",".($y+100)."]],[-4.95,-4.95]],";
				break;
			case 1:
				echo "[[$x,$y,21,99],[7,0]],[[[".($x+78).",".($y+100)."],[".($x+83).",".($y+83)."],[".($x+100).",".($y+78)."],[".($x+100).",".($y+100)."]],[-4.95,-4.95]],[[[".($x+100).",".($y+22)."],[".($x+83).",".($y+17)."],[".($x+78).",$y],[".($x+100).",$y]],[-4.95,4.95]],";
				break;
			case 2:
				echo "[[$x,".($y+78).",99,21],[0,-7]],[[[".($x+100).",".($y+22)."],[".($x+83).",".($y+17)."],[".($x+78).",$y],[".($x+100).",$y]],[-4.95,4.95]],[[[".($x+22).",$y],[".($x+17).",".($y+17)."],[$x,".($y+22)."],[$x,$y]],[4.95,4.95]],";
				break;
			case 3:
				echo "[[".($x+78).",$y,21,99],[-7,0]],[[[".($x+22).",$y],[".($x+17).",".($y+17)."],[$x,".($y+22)."],[$x,$y]],[4.95,4.95]],[[[$x,".($y+78)."],[".($x+17).",".($y+83)."],[".($x+22).",".($y+100)."],[$x,".($y+100)."]],[4.95,-4.95]],";
				break;
			case 4:
				echo "[[[$x,".($y+22)."],[".($x+34).",".($y+25)."],[".($x+58).",".($y+36)."],[".($x+73).",".($y+66)."],[".($x+76).",".($y+100)."],[".($x+100).",".($y+100)."],[".($x+100).",$y],[$x,$y]],[-4.95,4.95]],[[[$x,".($y+78)."],[".($x+17).",".($y+84)."],[".($x+22).",".($y+100)."],[$x,".($y+100)."]],[4.95,-4.95]],";
				break;
			case 5:
				echo "[[[".($x+22).",".($y+100)."],[".($x+25).",".($y+66)."],[".($x+36).",".($y+42)."],[".($x+66).",".($y+27)."],[".($x+100).",".($y+24)."],[".($x+100).",$y],[$x,$y],[$x,".($y+100)."]],[4.95,4.95]],[[[".($x+78).",".($y+100)."],[".($x+84).",".($y+83)."],[".($x+100).",".($y+78)."],[".($x+100).",".($y+100)."]],[-4.95,-4.95]],";
				break;
			case 6:
				echo "[[[".($x+100).",".($y+78)."],[".($x+66).",".($y+75)."],[".($x+42).",".($y+64)."],[".($x+27).",".($y+34)."],[".($x+24).",$y],[$x,$y],[$x,".($y+100)."],[".($x+100).",".($y+100)."]],[4.95,-4.95]],[[[".($x+100).",".($y+22)."],[".($x+83).",".($y+16)."],[".($x+78).",$y],[".($x+100).",$y]],[-4.95,4.95]],";
				break;
			case 7:
				echo "[[[".($x+78).",$y],[".($x+75).",".($y+34)."],[".($x+64).",".($y+58)."],[".($x+34).",".($y+73)."],[$x,".($y+76)."],[$x,".($y+100)."],[".($x+100).",".($y+100)."],[".($x+100).",$y]],[-4.95,-4.95]],[[[".($x+22).",$y],[".($x+16).",".($y+17)."],[$x,".($y+22)."],[$x,$y]],[4.95,4.95]],";
				break;
			case 8:
				echo "[[$x,$y,99,21],[0,7]],[[$x,".($y+78).",99,21],[0,-7]],";
				break;
			case 9:
				echo "[[$x,$y,21,99],[7,0]],[[".($x+78).",$y,21,99],[-7,0]],";
				break;
			case 11:
				echo "[[[".($x+28).",".($y+86)."],[".($x+50).",".($y+50)."],[".($x+50).",".($y+90)."]],[-0.67,2.92]],[[[".($x+50).",".($y+90)."],[".($x+50).",".($y+50)."],[".($x+72).",".($y+86)."]],[0.67,2.92]],[[[".($x+72).",".($y+86)."],[".($x+50).",".($y+50)."],[".($x+86).",".($y+72)."]],[2.12,2.12]],[[[".($x+50).",".($y+50)."],[".($x+28).",".($y+86)."],[".($x+14).",".($y+72)."]],[-2.23,2.01]],[[[".($x+14).",".($y+72)."],[".($x+50).",".($y+50)."],[".($x+10).",".($y+50)."]],[-2.92,0.67]],[[[".($x+86).",".($y+72)."],[".($x+50).",".($y+50)."],[".($x+90).",".($y+50)."]],[2.92,0.67]],[[[".($x+50).",".($y+50)."],[".($x+10).",".($y+50)."],[".($x+14).",".($y+28)."]],[-2.92,-0.67]],[[[".($x+50).",".($y+50)."],[".($x+14).",".($y+28)."],[".($x+28).",".($y+14)."]],[-2.12,-2.12]],[[[".($x+50).",".($y+50)."],[".($x+28).",".($y+14)."],[".($x+50).",".($y+10)."]],[-0.67,-2.92]],[[[".($x+50).",".($y+50)."],[".($x+50).",".($y+10)."],[".($x+72).",".($y+14)."]],[0.95,-2.85]],[[[".($x+50).",".($y+50)."],[".($x+72).",".($y+14)."],[".($x+86).",".($y+28)."]],[2.32,-1.9]],[[[".($x+50).",".($y+50)."],[".($x+86).",".($y+28)."],[".($x+90).",".($y+50)."]],[2.92,-0.67]],[[[$x,".($y+22)."],[".($x+17).",".($y+17)."],[".($x+22).",$y],[$x,$y]],[4.95,4.95]],[[[".($x+78).",$y],[".($x+83).",".($y+17)."],[".($x+100).",".($y+22)."],[".($x+100).",$y]],[-4.95,4.95]],[[[$x,".($y+78)."],[".($x+17).",".($y+83)."],[".($x+22).",".($y+100)."],[$x,".($y+100)."]],[4.95,-4.95]],[[[".($x+78).",".($y+100)."],[".($x+83).",".($y+83)."],[".($x+100).",".($y+78)."],[".($x+100).",".($y+100)."]],[-4.95,-4.95]],";
				break;
			case 12:
				echo "[[$x,".($y+40).",21,59],[7,0]],[[".($x+78).",".($y+40).",21,59],[-7,0]],[[[".($x+22).",".($y+40)."],[".($x+40).",".($y+22)."],[".($x+40).",$y],[$x,$y],[$x,".($y+40)."]],[5.12,4.78]],[[".($x+40).",$y,19,21],[0,7]],[[[".($x+60).",$y],[".($x+60).",".($y+22)."],[".($x+78).",".($y+40)."],[".($x+100).",".($y+40)."],[".($x+100).",$y]],[-5.12,4.78]],";
				break;
			case 13:
				echo "[[".($x+40).",".($y+78).",59,21],[0,-8]],[[".($x+40).",$y,59,21],[0,8]],[[[".($x+40).",".($y+78)."],[".($x+22).",".($y+60)."],[$x,".($y+60)."],[$x,".($y+100)."],[".($x+40).",".($y+100)."]],[5.46,-5.85]],[[$x,".($y+40).",21,19],[8,0]],[[[$x,".($y+40)."],[".($x+22).",".($y+40)."],[".($x+40).",".($y+22)."],[".($x+40).",$y],[$x,$y]],[5.46,5.85]],";
				break;
			case 14:
				echo "[[".($x+78).",$y,21,59],[-8,0]],[[$x,$y,21,59],[8,0]],[[[".($x+78).",".($y+60)."],[".($x+60).",".($y+78)."],[".($x+60).",".($y+100)."],[".($x+100).",".($y+100)."],[".($x+100).",".($y+60)."]],[-5.85,-5.46]],[[".($x+40).",".($y+78).",19,21],[0,-8]],[[[".($x+40).",".($y+100)."],[".($x+40).",".($y+78)."],[".($x+22).",".($y+60)."],[$x,".($y+60)."],[$x,".($y+100)."]],[5.85,-5.46]],";
				break;
			case 15:
				echo "[[$x,$y,59,21],[0,8]],[[$x,".($y+78).",59,21],[0,-8]],[[[".($x+60).",".($y+22)."],[".($x+78).",".($y+40)."],[".($x+100).",".($y+40)."],[".($x+100).",$y],[".($x+60).",$y]],[-5.46,5.85]],[[".($x+78).",".($y+40).",21,19],[-8,0]],[[[".($x+100).",".($y+60)."],[".($x+78).",".($y+60)."],[".($x+60).",".($y+78)."],[".($x+60).",".($y+100)."],[".($x+100).",".($y+100)."]],[-5.46,-5.85]],";
				break;
			}
		}
		echo '],';
