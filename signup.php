...
<main>
	...
	if (!$inscrit) {
		...
		<table class="signup">
		<tr><td class="ligne"><label for="pseudo"><?php echo $language ? 'Choose a nick':'Choisissez un pseudo'; ?> :</label></td><td><input type="text" role="input" name="pseudo" id="pseudo" value="<?php if (isset($pseudo)) echo $pseudo ?>" maxlength="30" /></td></tr>
		...
		<tr><td class="ligne"><label for="email"><?php echo $language ? 'Email address <em>(optionnal)</em>':'Adresse email <em>(facultatif)</em>'; ?> :</label></td><td><input type="email" name="email" id="email" value="<?php if (isset($email)) echo $email ?>" /></td></tr>
		<tr><td class="ligne"><label for="country"><?php echo $language ? 'Country <em>(optionnal)</em>':'Pays <em>(facultatif)</em>'; ?> :</label></td><td><select name="country" id="country"><?php
