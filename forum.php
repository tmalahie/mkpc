		...
		?>
			...
			<form method="post" action="forum.php" <?php if (isset($warningDeleted)) echo ' style="height:0;overflow:hidden"'; ?>>
				<table id="connexion">
					...
					?>
					<tr>
						<td class="ligne"><label for="pseudo"><?php echo $language ? 'Login' : 'Pseudo'; ?> :</label></td>
						<td><input type="text" name="pseudo" id="pseudo" <?php echo isset($_POST['pseudo']) ? ' value="' . $_POST['pseudo'] . '"' : null; ?> /></td>
					</tr>
					<tr>
						<td class="ligne"><label for="code"><?php echo $language ? 'Password' : 'Code'; ?> :</label></td>
						<td><input type="password" name="code" id="code" <?php echo isset($_POST['code']) ? ' value="' . $_POST['code'] . '"' : null; ?> /></td>
					</tr>
					<tr>
						<td colspan="2"><input type="submit" value="<?php echo $language ? 'Submit' : 'Valider'; ?>" /></td>
					</tr>
					<tr>
						<td colspan="2">
