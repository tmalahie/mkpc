...
function includeShareLib() {
    global $nid, $creationType, $cName, $cPrefix, $cAuteur, $cDate, $cDesc, $commentsLocked, $pNote, $pNotes, $isCup, $isMCup, $isBattle, $cupIDs, $clId, $sid, $cOptions, $identifiants, $language, $creator, $canShare, $canChange, $creationMode, $trackEditPage, $cNote, $ctActions;
    ...
    ?>
	circuitName = "<?php echo addSlashes(htmlEscapeCircuitNames($cName)) ?>", circuitAuthor = "<?php echo addSlashes(htmlEscapeCircuitNames($cAuteur)) ?>", circuitDesc = <?php echo json_encode($cDesc) ?>, commentsLocked = <?php echo $commentsLocked ? 'true':'false' ?>, circuitNote = <?php echo $pNote ?>, circuitNotes = <?php echo $pNotes ?>,
