...
function print_forum_msg($message,$options=array()) {
	...
	echo '<div class="mContent">';
		echo '<div class="mHeader'. ($mayEdit ? ' mCanEdit':'') .'">';
			...
			. ($canModerate&&empty($options['archived']) ? '<a href="#null" onclick="archiveReport('.$message['reportid'].');return false" class="mArchive" title="'. ($language ? 'Archive report':'Archiver le signalement') .'"><img src="images/forum/archive.png" alt="'. ($language ? 'Archive':'Archiver') .'" /></a>':'')
			. ($canModerate&&!empty($options['archived']) ? '<a href="#null" onclick="unarchiveReport('.$message['reportid'].');return false" class="mArchive" title="'. ($language ? 'Unarchive report':'Désarchiver le signalement') .'"><img src="images/forum/unarchive.png" alt="'. ($language ? 'Unarchive':'Désarchiver') .'" /></a>':'')
			. '</div>';
		echo '</div>';
