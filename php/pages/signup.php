...
<main>
	...
	if (!$inscrit) {
		...
		<tr><td class="ligne"><label for="country"><?php echo $language ? 'Country <em>(optional)</em>':'Pays <em>(facultatif)</em>'; ?><?php echo $language ? ':':' :'; ?></label></td><td><select name="country" id="country"><?php
