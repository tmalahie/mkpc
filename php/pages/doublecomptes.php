...
<main>
	...
	<blockquote>
	<p><label for="pseudo"><strong><?php echo $language ? 'Enter the username':'Pseudo du joueur'; ?></strong></label><?php echo $language ? ':' : ' :'; ?> <input type="text" name="pseudo" id="pseudo" /> <input type="submit" value="<?php echo $language ? 'Validate' : 'Valider'; ?>" class="action_button" /></p>
	</blockquote>
	</form>
