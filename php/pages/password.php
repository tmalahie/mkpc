...
<main>
	...
	<table>
	<tr><td class="ligne"><label for="ancien"><?php echo $language ? 'Old password':'Ancien mot de passe'; ?><?php echo $language ? ':':' :'; ?></label></td><td><input type="password" name="ancien" id="ancien"<?php if (isset($ancien)) echo ' value="'.htmlspecialchars($ancien).'"'; ?> maxlength="30" /></td></tr>
	<tr><td class="ligne"><label for="nouveau"><?php echo $language ? 'New password':'Nouveau mot de passe'; ?><?php echo $language ? ':':' :'; ?></label></td><td><input type="password" name="nouveau" id="nouveau"<?php if (isset($nouveau)) echo ' value="'.htmlspecialchars($nouveau).'"'; ?> maxlength="30" /></td></tr>
	<tr><td class="ligne"><label for="confirm"><?php echo $language ? 'Re-enter the password':'Retapez le mot de passe'; ?><?php echo $language ? ':':' :'; ?></label></td><td><input type="password" name="confirm" id="confirm"<?php if (isset($confirm)) echo ' value="'.htmlspecialchars($confirm).'"'; ?> maxlength="30" /></td></tr>
