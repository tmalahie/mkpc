...
<main>
	...
	if (!$pids) {
		...
		You can share your own circuit creations by clicking on the &quot;Share circuit&quot; button at the bottom-left of the circuit page.' :
	...
	<form method="get" action="creations.php" id="form-search">
		...
		if ($managing) {
			...
			<div>
				<label>
					<?php echo $language ? '<em>OR</em> &nbsp;<strong>Track URL</strong>':'<em>OU</em> &nbsp;<strong>URL circuit</strong>'; ?><?php echo $language ? ':':' :'; ?>
