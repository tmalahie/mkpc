...
if ($console && !$isPollClosed && isset($_POST['vote'])) {
    ...
    if (isset($teamsDict[$vote])) {
        if ($id) {
            ...
            $success .= '<a href="news.php?id=15280">'. ($language ? 'Back to MKWC news':'Retour &agrave; la news MKWC') .'</a>';
...
<body>
    ...
    <main>
        ...
        <p class="forumButtons">
            ...
            ?>
            <a href="news.php?id=15280"><?php echo $language ? 'Back to MKWC news':'Retour à la news MKWC'; ?></a><br />
