...
<main>
	...
	<?php
	if (isset($success))
		echo $language ? '<p class="success">Your new username is now <strong>'. htmlspecialchars($new) .'</strong>.</p>' : '<p class="success">Vous avez été renommé en <strong>'. htmlspecialchars($new) .'</strong>.</p>';
	if (isset($message))
