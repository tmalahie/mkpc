...
<main>
	...
	if (!$inscrit) {
		...
		<tr><td class="ligne"><label for="confirm"><?php echo $language ? 'Re-enter password':'Retapez le mot de passe'; ?><?php echo $language ? ':':' :'; ?></label></td><td><input type="password" name="confirm" id="confirm" value="<?php if (isset($confirm)) echo $confirm ?>" maxlength="30" /></td></tr>
		<tr><td class="ligne"><label for="email"><?php echo $language ? 'Email address <em>(optional)</em>':'Adresse email <em>(facultatif)</em>'; ?><?php echo $language ? ':':' :'; ?></label></td><td><input type="email" name="email" id="email" value="<?php if (isset($email)) echo $email ?>" /></td></tr>
		<tr><td class="ligne"><label for="country"><?php echo $language ? 'Country <em>(optional)</em>':'Pays <em>(facultatif)</em>'; ?><?php echo $language ? ':':' :'; ?></label></td><td><select name="country" id="country" value="<?php if (isset($country)) echo $country ?>"><?php
