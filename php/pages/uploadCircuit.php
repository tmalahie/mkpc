...
if (isset($_FILES['image'])) {
	if (!$_FILES['image']['error']) {
		...
		else $error = $language ? 'Your image mustn\'t exceed '.filesize_str($maxUploadSize).'. Compress or reduce it if necessary.':'Votre image ne doit pas dépasser '.filesize_str($maxUploadSize).'. Compressez-la ou réduisez la taille si nécessaire.';
	}
