...
function printCollabPopup($params) {
    ...
    ?>">
        ...
        <form class="collab-form collab-popup-section<?php if (!$hasLinks) echo ' add show'; ?>" data-type="<?php echo $itemType; ?>" data-id="<?php echo $itemId; ?>" data-onsave="onSavePopupCollab">
