...
function move(getId) {
	...
	if (!oKart.z) {
		...
		if (pJump && !oKart.tourne) {
			...
			else if (!oKart.protect && !oKart.champi && !oKart.z && !oKart.figuring && oKart.speed > 1.5 && !(oKart.turbodrift>12) && (hpType=ralenti(posx_arrondi, posy_arrondi))) {
				var capSpeed;
				switch (hpType) {
					case "herbe" :
