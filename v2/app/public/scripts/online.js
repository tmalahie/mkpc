...
function o_invitesb() {
	...
	if (!document.getElementById("coliste")) {
		...
		o_infos.innerHTML = o_language ? "Chat with other members or invite them <a href=\"online.php\" target=\"_blank\">online</a>.":"Ici, discutez avec les autres membres, ou invitez-les &agrave; vous affronter dans le <a href=\"online.php\" target=\"_blank\">mode en ligne</a>.";
