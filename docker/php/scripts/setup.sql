...
CREATE TABLE `arenes` (
  ...
  `auteur` varchar(255) COLLATE latin1_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE `mkrecords_bkp` (
  ...
  `identifiant4` int(10) unsigned NOT NULL,
  `player` int(11) NOT NULL,
  `perso` varchar(255) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
INSERT INTO `mkcategories` VALUES (0,'Topics officiels','Official topics','Dans cette cat̩gorie, vous trouverez toutes les annonces et informations officielles de Mario Kart PC. Il est obligatoire de lire ces topics avant de poster un message sur le forum.','In this section you will find all the official information of Mario Kart PC. Read these topics before posting any message on the forum.',0,1,1),(1,'Annonces et pr̩sentations','Announcements and presentations','Dans cette cat̩gorie, postez toutes les annonces en rapport ou non avec le site : news, ̩v̩nements, pr̩sentations, absences et retours.','In this section, you can put announces directly related (or not) to MKPC: such as news, events, self-presentations, departures or returns',1,2,0),(2,'Le jeu','The game','Ici, parlez de tout ce qui a un rapport avec MKPC : organisez des tournois, pr̩sentez vos cr̩ations de circuits, donnez des suggestions d\'am̩lioration...','This sections concerns everything exclusively related to MKPC : tournaments, newly created circuits, suggestions for improvements',2,3,0),(3,'Blabla divers','Various discussions','Section libre. Discutez de tout ce que vous voulez qui n\'a pas de rapport direct avec le site. Mini-fics, jeux vid̩os, ̩nigmes... Tout est permis !','Here, talk about what you want that has no direct relation MKPC. Mini-fic, video games, puzzles ... Everything is possible!',3,4,0),(4,'Blabla international','International forum','Cette cat̩gorie a pour but de permettre l\'̩change avec les membres non-francophones du site. Vous pouvez y parler de tout, une seule r̬gle : ̩crivez en anglais !','The current forum is mainly used by French people. So if you are not French, this category is for you: its aim is to allow communication between people from every country. You can talk about everything on it, the only rule is: write in English!',4,0,0);
