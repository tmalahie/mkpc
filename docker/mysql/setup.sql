...
CREATE TABLE `mkcltry` (
  ...
  `date` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38625 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `mkghosts` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `identifiant` (`identifiant`,`identifiant2`,`identifiant3`,`identifiant4`,`circuit`),
  KEY `perso` (`perso`(191))
) ENGINE=InnoDB AUTO_INCREMENT=2494 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `mkmatches` (
  ...
  PRIMARY KEY (`id`),
  KEY `date` (`date`)
) ENGINE=MyISAM AUTO_INCREMENT=3524 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `mknotifs` (
  ...
  KEY `user` (`user`,`type`)
) ENGINE=MyISAM AUTO_INCREMENT=548174 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mko` (
...
CREATE TABLE `mkrecords` (
  ...
  PRIMARY KEY (`id`),
  KEY `perso` (`perso`(191)),
  KEY `type` (`type`,`circuit`),
  KEY `identifiant` (`identifiant`,`identifiant2`,`identifiant3`,`identifiant4`,`type`,`circuit`) USING BTREE,
  KEY `player` (`player`,`type`,`circuit`)
) ENGINE=InnoDB AUTO_INCREMENT=20552 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
INSERT INTO `mkcategories` VALUES (0,'Topics officiels','Official topics','Dans cette cat̩gorie, vous trouverez toutes les annonces et informations officielles de Mario Kart PC. Il est obligatoire de lire ces topics avant de poster un message sur le Forum.','In this section you will find all the official information of Mario Kart PC. Read these topics before posting any message on the forum.',0,1,1),(1,'Annonces et pr̩sentations','Announcements and presentations','Dans cette cat̩gorie, postez toutes les annonces en rapport ou non avec MKPC : news, ̩v̩nements, pr̩sentations, absences et retours.','In this category, give all the ads related or not MKPC: news, events, presentations, absences and returns.',1,2,0),(2,'Le jeu','The game','Ici, parlez de tout ce qui a un rapport avec le jeu : organisez des tournois, pr̩sentez vos cr̩ations de circuits, donnez des suggestions d\'am̩lioration...','Here talk about everything that has to do with the game: organize tournaments, present your creations circuits, give suggestions for improvement, ...',2,3,0),(3,'Blabla divers','Various discussions','Section libre. Discutez de tout ce que vous voulez qui n\'a pas de rapport direct avec MKPC. Mini-fics, jeux vid̩os, ̩nigmes... Tout est permis !','Here, talk about what you want that has no direct relation MKPC. Mini-fic, video games, puzzles ... Everything is possible!',3,4,0),(4,'Blabla international','International forum','Cette cat̩gorie a pour but de de permettre l\'̩change avec les membres non-francophones du site. Vous pouvez y parler de tout, une seule r̬gle : ̩crivez en anglais !','The current forum is mainly used by French people. So if you are not French, this category is for you: its aim is to allow communication between people from every country. You can talk about everything on it, the only rule is: write in English!',4,0,0);
